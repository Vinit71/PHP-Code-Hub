...
$stmarks = array("Vinit"=> "100", "Chaya" => "90", "Random" => "10"); //Associative array

echo "Vinit got: ", $stmarks['Vinit'], " marks"; //printing

/* Associative arrays store data as key-value pairs, where each key is unique and maps to a specific value.
